...
import { getSavedReceiptPaperWidth, installReceiptPrintPageSizing, prepareReceiptPrintPage } from "@/lib/receipt/print";
...
export function ReceiptPrintHost({ receipt }: { receipt: ReceiptData | null }) {
  ...
  const resolvedReceipt = receipt.paperWidth ? receipt : { ...receipt, paperWidth: getSavedReceiptPaperWidth() };
